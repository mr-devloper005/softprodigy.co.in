export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'softprodigy',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Softprodigy',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'softprodigy.co.in',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://softprodigy.co.in',
